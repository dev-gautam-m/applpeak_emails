    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.servers.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', 'sanket@applpeak.com') }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hostname') ? 'is-invalid' : '' }}" type="text" name="hostname" id="hostname" value="{{ old('hostname', 'smtp.hostinger.com') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('username') ? 'is-invalid' : '' }}" type="text" name="username" id="username" value="{{ old('username', 'sanket@applpeak.com') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('password') ? 'is-invalid' : '' }}" type="text" name="password" id="password" value="{{ old('password', '66eR[A~@5OuY') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('port') ? 'is-invalid' : '' }}" type="number" name="port" id="port" value="{{ old('port', '587') }}" step="1">
                @if($errors->has('port'))
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('protocol') ? 'is-invalid' : '' }}" name="protocol" id="protocol">
                    ...
                    @foreach(App\Models\Server::PROTOCOL_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('protocol', 'tsl') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('from_email') ? 'is-invalid' : '' }}" type="text" name="from_email" id="from_email" value="{{ old('from_email', 'sanket@applpeak.com') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('from_name') ? 'is-invalid' : '' }}" type="text" name="from_name" id="from_name" value="{{ old('from_name', 'Sanket Rajodiya') }}" required>
